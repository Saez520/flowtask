    ...
    "experimental.chat.system.transform": async (
      ...
      try {
        ...
        const instruction = [
          ...
          "2. Guardar tu estado actual en Engram con mem_save:",
          "   - Si hay CA activo:",
          "     mem_save(",
          "       type: \"decision\",",
          "       scope: \"project\",",
          ...
          "         updated_at: now(),",
          "         sequence: N,",
          "         flow_state: { ca_id, agente, instance_name, ... }",
          "       }",
          "     )",
          "   - Si no hay CA (operación independiente):",
          "     mem_save(",
          "       type: \"decision\",",
          "       scope: \"project\",",
          ...
          "         flow_state: { operation_id, agente, instance_name, ... }",
          "       }",
          "     )",
          `3. Incluir EXACTAMENTE esta línea en tu respuesta: [FLOWTASK_CHECKPOINT_CAPACITY: ${pct}%]`,
          "",
          "Esto permite al runner relanzarte en una nueva instancia con contexto fresco, restaurando el estado desde el checkpoint.",
        ].join("\n");
